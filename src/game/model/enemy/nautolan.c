...
void initialize_nautolan_enemy(Enemy *enemy)
{
    ...
    case SUPPORT:
        ...
        enemy->enemy_animation.ship[DESTRUCTION] = construct_animation("assets/sprites/Ships/EnemyFleet/Nautolan/Destruction/Support.png", 9, enemy->dimension, BACKWARD);
