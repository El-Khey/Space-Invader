...
void initialize_klaed_enemy(Enemy *enemy)
{
    ...
    case BATTLECRUISER:
        ...
        enemy->enemy_animation.ship[ATTACK] = construct_animation("assets/sprites/Ships/EnemyFleet/Kla'ed/Weapons/Battlecruiser.png", 1, enemy->dimension, BACKWARD);
        enemy->enemy_animation.ship[DESTRUCTION] = construct_animation("assets/sprites/Ships/EnemyFleet/Kla'ed/Destruction/Battlecruiser.png", 1, enemy->dimension, BACKWARD);
